...
namespace Evaluaciones.Web.UI.Areas.Home.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(Evaluaciones.Web.UI.Areas.Home.Models.Login model)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult RecoveryPass(Evaluaciones.Web.UI.Areas.Home.Models.RecoveryPass model)
        {
            string textoRun = model.RUN.Replace(".", string.Empty).Replace("-", string.Empty);
